...
#[derive(Clone, Debug)]
pub struct CommandTemplate { pub pipeline: Pipeline, pub implicit_all: bool }
#[derive(Clone, Debug)]
pub struct Pipeline { pub commands: Vec<CommandInvocation> }
#[derive(Clone, Debug)]
pub struct CommandInvocation { pub arguments: Vec<Argument>, pub input: Option<Argument>, pub output: Option<(Argument, bool)> }
#[derive(Clone, Debug)]
